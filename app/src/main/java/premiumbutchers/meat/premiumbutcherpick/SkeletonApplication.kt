...
import premiumbutchers.meat.premiumbutcherpick.di.dataModule
import premiumbutchers.meat.premiumbutcherpick.di.dispatcherModule
import premiumbutchers.meat.premiumbutcherpick.di.viewModule
...
class RUWCZApplication : Application() {
    //[FIREBASE][appScope]
    ...
    override fun onCreate() {
        ...
        startKoin {
            androidLogger()
            androidContext(this@RUWCZApplication)
            modules(appModules)
        }
